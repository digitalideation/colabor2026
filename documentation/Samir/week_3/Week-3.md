...
I created a new coe (with some help of claude ai) where I show the Song Scatman with the lyris and each new click changes either the background or the font color depending on which side you click on the screen, as well I added some hydra function to either make it more pixelated or rotate it.
...
```
![[P5L_Scatman John_20260517171138.png]]
![P5L_Scatman John_20260517171138](/Users/stash/Library/CloudStorage/OneDrive-Persönlich/03_DMI/4. Semester/CO_Creative_Coding/documentation/week_3/P5L_Scatman John_20260517171138.png)
