// {"P5LIVE":{"name":"split_screen_audioreactive","mod":1780155758782}} 
...
function draw() {
	...
	else if(blinkCenter == 0) { centerLayer.background(0) }
	...
	//horizontalStretch(centerLayer, width / 3, height, 10, 10, 9, "?")
