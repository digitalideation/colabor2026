...
//Rain Code Config
let texts = ["demand", "could rise", "to 1,200 billion", "liters by 2030", "equivalent to", "ten million households"];
let rain = [];
...
![[Screenshot 2026-06-01 at 20.02.44.png]]
...
```
![[P5L_new_001_20260601222025.png]]
#### Vocal Glitch VCV Rack
![[Screenshot 2026-05-31 at 16.27.03.png]]